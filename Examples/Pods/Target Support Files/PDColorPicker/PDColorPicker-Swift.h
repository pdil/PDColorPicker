...
SWIFT_MODULE_NAMESPACE_PUSH("PDColorPicker")
@class UIColor;
@class UIFont;
@class NSCoder;
@class NSBundle;
...
///
/// \endcode<em>Note</em> Dimming the presenting view controller is recommended
/// for a better appearance.
/// See the <code>Dimmable</code> protocol.
SWIFT_CLASS("_TtC13PDColorPicker27PDColorPickerViewController")
@interface PDColorPickerViewController : UIViewController
/// The tint color of the <em>Save</em> button.
...
@property (nonatomic) BOOL showHexString;
/// The font to be used on the <em>Cancel</em> button and color preview.
/// The default value is the system font at size 18.
@property (nonatomic, strong) UIFont * _Nonnull font;
/// The font to be used on the <em>Save</em> button.
...
@interface PDColorPickerViewController (SWIFT_EXTENSION(PDColorPicker)) <UIDragInteractionDelegate>
